...
_SALES_SCHEMA: Schema = (
    ...
    ("Quantity", INT_NN),
    ("ListPrice", DECIMAL(8, 2, not_null=True)),
...
DIM_SCHEMAS: Dict[str, Schema] = {
    ...
    "Plans": (
        ...
        ("MonthlyPrice", DECIMAL(10, 2, not_null=False)),
    ...
    "CustomerSubscriptions": (
        ...
        ("CustomerKey", INT_NN),
        ("PlanKey", INT_NN),
        ("SubscribedDate", DATETIME2(7, not_null=True)),
        ("CancelledDate", DATETIME2(7, not_null=False)),
        ("Status", VARCHAR(20, not_null=True)),
        ("MonthlyPrice", DECIMAL(10, 2, not_null=True)),
        ("AutoRenew", BIT(not_null=True)),
        ("TrialEndDate", DATETIME2(7, not_null=False)),
